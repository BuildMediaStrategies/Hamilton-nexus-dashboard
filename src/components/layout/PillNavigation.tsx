...
import { Briefcase, Users, Building2, BookText, FileText, Receipt, ChartBar as BarChart3, Settings, Bell, LogOut, TestTube } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'test', label: 'Test Sync', icon: TestTube },
